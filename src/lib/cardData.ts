...
export const moneyCards: MoneyCard[] = [
  ...
  // 2M cards
  {
    ...
    type: 'money',
    name: 'Toy Ball',
    description: 'A fun ball for pets to play with',
    emoji: '⚽',
    value: 2,
  },
  {
  ...
  // 3M cards
  {
    ...
    type: 'money',
    name: 'Premium Treats',
    description: 'Gourmet treats for spoiled pets',
    emoji: '🍖',
    value: 3,
  },
  {
  ...
  // 4M cards
  {
    ...
    type: 'money',
    name: 'Luxury Pet Bed',
    description: 'The comfiest bed for pampered pets',
    emoji: '🛏️',
    value: 4,
  },
...
export const colorThemes: Record<PropertyColor, { bg: string; border: string; text: string }> = {
  'poodle-park': {
    bg: 'bg-pink-100',
